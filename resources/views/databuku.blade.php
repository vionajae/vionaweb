          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a
                ...
                <div data-i18n="Chat">Register Admin</div>
              </a>
            </li>
            <!-- Apps -->
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tabel / </span> Data Buku </h4>
              ...
              <div class="card">
                <div class="demo-inline-spacing d-flex justify-content-end mx-2">
                  <a class="btn btn-primary" href="{{url('tambah')}}"  role="button">Tambah</a>
                </div>
                <div class="card-body">
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu">
                                    <a href="{{url('editbuku/'.$inem->BukuID)}}" class="dropdown-item"
                                      ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                    >
                                    <a href="{{url('hapusbuku/'.$inem->BukuID)}}" class="dropdown-item"
