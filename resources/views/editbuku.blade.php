          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a
                ...
                <div data-i18n="Email">Tambah Buku</div>
              </a>
            </li>
            <li class="menu-item ">
              <a
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                ...
                <form action="{{url('editbuku/'.$data->BukuID)}}" method="post">
                  @csrf
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="number" class="form-control" name="TahunTerbit" value="{{$data->TahunTerbit}}" />
                          </div>
                        </div>
                        <div class="row mb-3">
